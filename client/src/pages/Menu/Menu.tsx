...
const foodSections: MenuSection[] = [
    {
        ...
        items: [
            {
                name: "Utopenec",
                description: "čerstvý chléb, beraní rohy",
                weight: "1 ks",
                allergens: "1, 10",
                price: "79 Kč"
            },
            {
                name: "Pikantní masová směs na topince",
                description: "sypaná sýrem, zelný salát",
                weight: "100 g",
                allergens: "1, 7",
                price: "159 Kč"
            },
            {
                name: "Smažené bramborové lupínky",
                description: "ďábelský / česnekový dip",
                weight: "200 g",
                allergens: "3, 7",
                price: "139 Kč"
            },
            ...
            {
                name: "Naše bramboráčky",
                description: "s restovaným uzeným masem, kysané zelí",
                weight: "4 ks",
                allergens: "1, 3, 7, 10",
                price: "139 Kč"
            },
    ...
    },
    {
        ...
        items: [
            {
                name: "Teplá klobása",
                description: "s čerstvým křenem / hořčicí / čerstvý chléb",
                weight: "150 g",
                allergens: "1, 10",
                price: "159 Kč"
            },
    ...
    },
    {
        ...
        items: [
            {
                name: "Staročeská česnečka",
                description: "s naším uzeným masem, sýrem a krutony",
                weight: "0,45 l",
                allergens: "1, 7",
                price: "79 Kč"
            },
    ...
    },
    {
        ...
        items: [
            {
                name: "Vepřová játra na roštu",
                description: "s cibulkou a naší tatarskou omáčkou, hranolky",
                weight: "200 g",
                allergens: "1, 3, 7, 10",
                price: "239 Kč"
            },
            {
                name: "Silný hovězí guláš z kližky",
                description: "barevná cibule, domácí bramboráčky",
                weight: "200 g",
                allergens: "1, 3, 7",
                price: "269 Kč"
            },
            {
                name: "Pečené koleno bez kosti na černém pivu",
                description: "hořčice, křen, kyselá okurka, čerstvý chléb",
                weight: "500 g",
                allergens: "1, 10",
                price: "299 Kč"
            },
            {
                name: "Marinovaná vepřová žebírka",
                description: "pikantní medová marináda, zelný salát, čerstvý chléb",
                weight: "600 g",
                allergens: "1",
                price: "339 Kč"
            },
            {
                name: "Pečené staročeské kachní stehno",
                description: "bílé a červené zelí, variace knedlíků (bramborové, houskové)",
                weight: "350 g",
                allergens: "1, 3, 7, 10",
                price: "329 Kč"
            },
    ...
    },
    {
        ...
        items: [
            {
                name: "Filírovaný hovězí flank steak",
                description: "omáčka ze zeleného pepře, kapka smetany a koňaku",
                weight: "200 g",
                allergens: "1, 7",
                price: "379 Kč"
            },
            {
                ...
                description: "baby špenát, sušená rajčata, omáčka z pečeného česneku",
                weight: "200 g",
                allergens: "1, 7, 10",
                price: "299 Kč"
            },
            {
                name: "Grilovaná krkovice",
                description: "fazolové lusky, slanina, cibule, doporučená příloha: pečená brambora s česnekovým dipem",
                weight: "300 g",
                allergens: "1, 7",
                price: "289 Kč"
            },
            {
                name: "Hovězí tatarák",
                description: "červená cibulka, kapary, cornichons, hrubozrnná hořčice, topinky",
                weight: "150 g",
                allergens: "1, 3, 10",
                price: "289 Kč"
            },
            {
                name: "Kuřecí prso na másle a citronovém tymiánu",
                description: "s cukrovým hráškem, mátou a fenyklem",
                weight: "200 g",
                allergens: "7",
                price: "249 Kč"
            },
            {
                name: "Grilovaný steak z Mahi mahi",
                description: "s grilovanou sezónní zeleninou",
                weight: "200 g",
                allergens: "4, 7",
                price: "299 Kč"
            },
            {
                name: "Bramborové noky Napoletana",
                description: "můžeme doplnit i o masovou variantu",
                weight: "350 g",
                allergens: "1, 3, 7",
                price: "229 Kč"
            },
    ...
    },
    {
        ...
        items: [
            {
                name: "Katův šleh z vepřové panenky",
                description: "hranolky slabé (pikantní)",
                weight: "150 g",
                allergens: "1",
                price: "275 Kč"
            },
            {
                ...
                description: "domácí bulka, 200g hovězí, čedar, slaninová majonéza, hranolky",
                weight: "350 g",
    ...
    },
    {
        ...
        items: [
            {
                name: "Salát CAESAR",
                description: "kuřecí prsíčko, ančovičkový dresink, hoblinky parmazánu",
                weight: "350 g",
                allergens: "1, 3, 4, 7, 10",
                price: "269 Kč"
            },
            {
                name: "Grilovaná panenka na listovém salátu",
                description: "rukola, sezónní zelenina, hořčičný dip",
                weight: "350 g",
                allergens: "10",
                price: "279 Kč"
            },
        ...
        <main className="min-h-screen bg-[#f7f0e8] text-[#2f241d]">
            <div className="mx-auto max-w-7xl px-4 py-6 md:px-8 lg:px-10">
                ...
                <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
                    <div>
                        <div
                            className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#f3e2d2] px-4 py-2 text-sm font-semibold text-[#8f5b2d] shadow-sm">
                    ...
                    <div className="rounded-4xl bg-[#3f2315] p-6 text-white md:p-8 shadow-xl">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <button
                                onClick={() => document.getElementById("k-pivu")?.scrollIntoView({behavior: "smooth"})}
                                className="rounded-full bg-white/10 px-4 py-2 hover:bg-white hover:text-[#3f2315] transition">Jídlo
                            </button>
                            <button
                                onClick={() => document.getElementById("tocene-pivo")?.scrollIntoView({behavior: "smooth"})}
                                className="rounded-full bg-white/10 px-4 py-2 hover:bg-white hover:text-[#3f2315] transition">Nápoje
                            </button>
                            <button
                                onClick={() => document.getElementById("sladke")?.scrollIntoView({behavior: "smooth"})}
                                className="rounded-full bg-white/10 px-4 py-2 hover:bg-white hover:text-[#3f2315] transition">Dezerty
                            </button>
                        </div>
                        <Link to="/kontakt"
                              className="mt-6 block w-full rounded-2xl bg-[#b87a44] py-4 text-center font-semibold hover:bg-[#c98950] transition shadow-lg">Rezervovat
                            stůl</Link>
                    </div>
                </div>
